...
public class MyFrame extends JFrame implements ActionListener {
	...
	public boolean Validate(String userName, String password) {
		 ...
		 * password.equals(verifiedPassword)){//create object of the second frame and
		 * hide this frame } else { //message box JOptionPane.showMessageDialog(this,
		 * "Enter a positive distance value!"); }
		 */
	}

//create new frame for seperate functionality
	@Override
